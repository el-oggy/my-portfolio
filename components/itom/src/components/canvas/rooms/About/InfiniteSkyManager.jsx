...
// Electronics / hardware skill set — textures generated by scripts/generate-art.mjs
const BALLOON_CONFIG = [
    // Large balloons (main skills) - front and center
    { texture: '/textures/about/balon_verilog.webp', paintedTexture: '/textures/about/balon_verilog_painted.webp', label: 'Verilog', size: 'large', x: -2.5, y: 2, z: 0.3, phase: 0 },
    { texture: '/textures/about/balon_systemverilog.webp', paintedTexture: '/textures/about/balon_systemverilog_painted.webp', label: 'SystemVerilog', size: 'large', x: 2.5, y: 2.5, z: 0.2, phase: 1.5 },
    { texture: '/textures/about/balon_stm32.webp', paintedTexture: '/textures/about/balon_stm32_painted.webp', label: 'STM32', size: 'large', x: 0, y: 3, z: 0.5, phase: 3 },

    // Medium balloons - scattered around
    { texture: '/textures/about/balon_ccpp.webp', paintedTexture: '/textures/about/balon_ccpp_painted.webp', label: 'C / C++', size: 'medium', x: -4, y: 1, z: -0.3, phase: 0.8 },
    { texture: '/textures/about/balon_esp32.webp', paintedTexture: '/textures/about/balon_esp32_painted.webp', label: 'ESP32', size: 'medium', x: 4, y: 1.5, z: -0.2, phase: 2.2 },
    { texture: '/textures/about/balon_arduino.webp', paintedTexture: '/textures/about/balon_arduino_painted.webp', label: 'Arduino', size: 'medium', x: 0, y: 0.5, z: -0.4, phase: 4 },

    // Small balloons - background accents
    { texture: '/textures/about/balon_vivado.webp', paintedTexture: '/textures/about/balon_vivado_painted.webp', label: 'Vivado', size: 'small', x: -5.5, y: 2.5, z: -0.8, phase: 1.2 },
    { texture: '/textures/about/balon_git.webp', paintedTexture: '/textures/about/balon_git_painted.webp', label: 'Git', size: 'small', x: 5.5, y: 3, z: -0.7, phase: 2.8 },
    { texture: '/textures/about/balon_kicad.webp', paintedTexture: '/textures/about/balon_kicad_painted.webp', label: 'KiCad', size: 'small', x: -3, y: 4.5, z: -0.5, phase: 3.5 },
    { texture: '/textures/about/balon_python.webp', paintedTexture: '/textures/about/balon_python_painted.webp', label: 'Python', size: 'small', x: 3.5, y: 4, z: -0.6, phase: 4.5 },
];
...
const SkillBalloon = ({ config, revealFactorRef, spreadFactorRef, timeRef }) => {
    ...
    const legacyAspects = {
        // Generated balloons (scripts/generate-art.mjs): all 640×1500
        'balon_verilog.webp': 640 / 1500,
        'balon_systemverilog.webp': 640 / 1500,
        'balon_stm32.webp': 640 / 1500,
        'balon_ccpp.webp': 640 / 1500,
        'balon_esp32.webp': 640 / 1500,
        'balon_arduino.webp': 640 / 1500,
        'balon_vivado.webp': 640 / 1500,
        'balon_git.webp': 640 / 1500,
        'balon_kicad.webp': 640 / 1500,
        'balon_python.webp': 640 / 1500,
