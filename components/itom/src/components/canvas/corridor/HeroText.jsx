...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for ADARSH split effect
    const letters = useMemo(() => [
        { char: 'A', baseX: -1.35, splitDir: -2.0, delay: 0 },
        { char: 'D', baseX: -0.81, splitDir: -1.2, delay: 0 },
        { char: 'A', baseX: -0.27, splitDir: -0.4, delay: 0 },
        { char: 'R', baseX: 0.27, splitDir: 0.4, delay: 0 },
        { char: 'S', baseX: 0.81, splitDir: 1.2, delay: 0 },
